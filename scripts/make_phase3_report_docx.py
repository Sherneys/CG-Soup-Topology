...
mr = meta.add_run("การเทียบแบบควบคุม C0/C1/C2/C3/C5 · Chamfer parity · เฉลี่ยข้าม seeds · "
                  "อ่านตัวเลขจากไฟล์ผลจริง · 7 กรกฎาคม 2569")
...
bullet(doc, "ยังจำกัดที่รูปทรงสังเคราะห์พื้นผิวปิด เรนเดอร์ 200×200 เครื่องเดียว — ShapeNet และข้อมูล "
            "ทันตกรรมจริงเป็นขั้นถัดไป (ตามลำดับที่ตกลงกับอาจารย์)")

# 7. next
H(doc, "7. ขั้นถัดไป")
bullet(doc, "C4: ถ่วงน้ำหนัก loss เชิงพื้นที่ด้วย curvature (ข้อ 3 ของอาจารย์) — ต้องเพิ่ม weight-mask "
            "ใน TopoLossState ก่อน")
bullet(doc, "ShapeNet subset (mesh ที่รู้ genus) เพื่อความทั่วไป → ป้อน paper ฉบับที่ 2 "
            "(Topology-Correcting Differentiable Rendering via Persistent Homology)")
