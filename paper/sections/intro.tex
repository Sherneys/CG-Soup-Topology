...
with no shared connectivity---is an attractive such
representation~\cite{tojo2026diffsoup}: it is cheap
...
% DiffSoup (Tojo et al.) = the triangle-soup pipeline this work builds on; our
% implementation of it is our own (provenance sentence in Section 3.2).
