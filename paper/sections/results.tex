...
% [p]: at full text width the three stacked rows are ~a full page tall, which an
% inline [h] float cannot place (it deferred itself + every later figure past the
% references). A dedicated float page keeps it near its Section 5.1 reference.
\begin{figure}[p]
\centering
\includegraphics[width=\linewidth]{pd_i_genus.png}\\[3pt]
\includegraphics[width=\linewidth]{pd_ii_components.png}\\[3pt]
\includegraphics[width=\linewidth]{pd_iii_void.png}
\caption{Persistence diagrams (GT / A / B) for the three blindness cases,
top to bottom: (i) genus, (ii) components, (iii) void.}
\label{fig:pd}
\end{figure}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.75\linewidth]{phantom.png}
...
prior; the H0 shapes are unaffected. (B5 was run on the torus only.)}
\label{fig:phantom2}
\end{figure}
