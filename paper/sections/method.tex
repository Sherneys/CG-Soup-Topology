...
The baseline resampler~\cite{tojo2026diffsoup} periodically (i) \emph{prunes} the least screen-visible
...
this is condition B0 below. We use our own implementation of this
pipeline~\cite{tojo2026diffsoup}; since the $\lambda_{\text{topo}}{=}0$ policy
reproduces its baseline resampler bit-identically, all reported numbers are with
respect to this implementation. The policy is field-agnostic: swapping which field it
